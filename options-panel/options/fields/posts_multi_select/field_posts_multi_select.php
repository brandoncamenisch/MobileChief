<?php
class PLUGINCHIEFMSB_Options_posts_multi_select extends PLUGINCHIEFMSB_Options{	
	...
	*/
	function render(){
		...
		$pluginchiefmsb_args = wp_parse_args($this->field['args'], array('numberposts' => '-1'));
		
		$posts = get_posts($pluginchiefmsb_args); 
