<?php
class PLCHF_MSB__Options_google_webfonts extends PLCHF_MSB__Options{	
	...
	*/
	function __construct($field = array(), $value ='', $parent){
		...
		$fonts = get_transient('plchf_msb_opts-google-webfonts');
		if(!is_array(json_decode($fonts))){
			...
			set_transient('plchf_msb_opts-google-webfonts', $fonts, 60 * 60 * 24);
