<?php
class PLUGINCHIEFMSB_Options_google_webfonts extends PLUGINCHIEFMSB_Options{	
	...
	*/
	function __construct($field = array(), $value ='', $parent){
		...
		$fonts = get_transient('pluginchiefmsb-opts-google-webfonts');
		if(!is_array(json_decode($fonts))){
			...
			set_transient('pluginchiefmsb-opts-google-webfonts', $fonts, 60 * 60 * 24);
