...
<html lang="en">
  ...
  <head>
  	...
  	<?php 
	global $pluginchiefmsb_startertheme_dir, $post, $wp_query;
	...
	?>
  	...
  	<link href="<?php echo $pluginchiefmsb_startertheme_dir; ?>mobile-themes/default-theme/theme/css/style.min.css" rel="stylesheet">
  	<link href="<?php echo $pluginchiefmsb_startertheme_dir; ?>mobile-themes/default-theme/theme/css/style-responsive.min.css" rel="stylesheet">
