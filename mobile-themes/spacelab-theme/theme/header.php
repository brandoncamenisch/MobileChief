...
<html lang="en">
  ...
  <head>
  	...
  	<?php
	global $pluginchiefmsb_spacelabtheme_dir, $post, $wp_query;
	...
	?>
  	...
  	<link href="<?php echo $pluginchiefmsb_spacelabtheme_dir; ?>theme/css/style.min.css" rel="stylesheet">
  	<link href="<?php echo $pluginchiefmsb_spacelabtheme_dir; ?>theme/css/style-responsive.min.css" rel="stylesheet">
