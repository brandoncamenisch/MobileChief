...
<html lang="en">
  ...
  <head>
  	...
  	<?php
	global $pluginchiefmsb_readabletheme_dir, $post, $wp_query;
	...
	?>
  	...
  	<link href="<?php echo $pluginchiefmsb_readabletheme_dir; ?>theme/css/style.min.css" rel="stylesheet">
  	<link href="<?php echo $pluginchiefmsb_readabletheme_dir; ?>theme/css/style-responsive.min.css" rel="stylesheet">
