...
---------------------------------------------------------------------------- */	
	...
	function plchf_msb_restaurant_theme_redirect_theme(){
	...
	add_filter('plchf_msb_theme_root_restaurant_theme','plchf_msb_restaurant_theme_redirect_theme');

/* ----------------------------------------------------------------------------
	Set the Current Page
---------------------------------------------------------------------------- */
	
	function plchf_msb_restaurant_theme_redirect_page(){
	...
	add_filter('plchf_msb_theme_page_restaurant_theme','plchf_msb_restaurant_theme_redirect_page');