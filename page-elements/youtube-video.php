	...
	function plchf_msb_page_element_settings_youtube_video($count, $values){
		...
		$fields[] = array(
			...
			'field' 	=> array(
				...
				'options'		=> array(
					'2'	=> 'Show Controls, Hide Progress Bar',
...
/* ---------------------------------------------------------------------------- */
	...
	function plchf_msb_page_element_output_youtube_video($values) {
		...
		echo '<iframe src="http://www.youtube.com/embed/'.$url2[0].'?autoplay='.$autoplay.'&controls='.$controls.'&loop='.$loop.'&rel='.$rel.'&showinfo='.$showinfo.'&theme='.$theme.'" frameborder="0" width="560" height="315"></iframe>';
