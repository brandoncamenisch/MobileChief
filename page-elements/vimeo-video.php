	...
	function plchf_msb_page_element_settings_vimeo_video($count, $values){
		...
		$fields[] = array(
			...
			'field' 	=> array(
				...
				'name' 			=> 'Color',
				'id' 			=> '_color_',
				'tooltip' 		=> 'Specify the color of the video controls',
				'placeholder'	=> '#cc3333',
			),
...
/* ---------------------------------------------------------------------------- */
	...
	function plchf_msb_page_element_output_vimeo_video($values) {
		...
		$color		= str_ireplace('#','',$values['_color_']);
		...
		echo '
		<iframe src="http://player.vimeo.com/video/'.$id.'?rel=0&wmode=opaque&title='.$title.'&byline='.$byline.'&portrait='.$portrait.'&color='.$color.'" width="500" height="281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
		';
