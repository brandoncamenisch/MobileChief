...
/* ---------------------------------------------------------------------------- */
	...
	function pluginchiefmsb_mobile_sites_menu_page() {
		...
		add_submenu_page( 
			...
			'Mobile Sites', 
			'add_users', 
			'pluginchiefmsb/mobile-sites.php', 
			'pluginchiefmsb_mobile_sites_menu_page_content' 
		);
	
	}
	
	add_action('admin_menu', 'pluginchiefmsb_mobile_sites_menu_page');
	
/* ---------------------------------------------------------------------------- */
/* Create the Menu Page Content
/* ---------------------------------------------------------------------------- */

	function pluginchiefmsb_mobile_sites_menu_page_content() {
	?>
